...
## Bước 3: Mục tiêu truy vấn (Querying)
...
- Ghi lại các trường hợp Flat RAG bị ảo giác nhưng GraphRAG trả lời đúng.
...
|------------|------------|--------|
| Để bắt đầu | NodeRAG | Tích hợp sẵn logic GraphRAG, không cần cấu hình database phức tạp |
| Trực quan hóa tốt nhất | Neo4j | Giao diện đồ họa giúp "thấy" được tri thức đang được kết nối như thế nào |
| Nghiên cứu thuật toán | NetworkX | Cho phép can thiệp sâu vào các thuật toán học của đồ thị |

---

## Tóm tắt quy trình GraphRAG
