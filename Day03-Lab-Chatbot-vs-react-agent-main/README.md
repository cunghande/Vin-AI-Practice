...
## Completed Submission Notes

This repository now includes a complete offline-friendly implementation:

- ReAct loop: `src/agent/agent.py`
- Baseline chatbot: `src/chatbot.py`
- E-commerce tools: `src/tools/ecommerce_tools.py`
...
Run the demo with the deterministic provider:

```bash
python scripts/demo.py "I want 2 headphones with coupon SAVE10 shipped to Hanoi. What is the total?"
```
