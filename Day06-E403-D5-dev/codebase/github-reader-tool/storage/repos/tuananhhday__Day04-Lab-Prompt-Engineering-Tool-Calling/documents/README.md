...
```bash
python grade/scoring.py --module simple_solution.agent.graph --provider custom --judge-provider custom
```

Run your implementation:

```bash
python grade/scoring.py --module src.agent.graph --provider custom --judge-provider custom
```
