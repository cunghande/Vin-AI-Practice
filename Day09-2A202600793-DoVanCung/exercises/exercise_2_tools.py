...
LEGAL_KNOWLEDGE = [
    ...
    },
    {
        ...
        "text": (
            ...
            "đơn phương chấm dứt hợp đồng trong một số trường hợp như người lao động "
            "thường xuyên không hoàn thành công việc, bị ốm đau/tai nạn đã điều trị "
            "quá thời hạn luật định, thiên tai/hỏa hoạn, hoặc người lao động đủ tuổi nghỉ hưu."
        ),
    },
]
