...
QUESTION = (
    "What statutes and case law apply to a breach of contract claim, and what legal "
...
SYSTEM_PROMPT = (
    ...
    "these tools to build a comprehensive analysis. Search relevant statutes and case law "
    "before answering. Keep your final answer under 500 words."
)
